...
class DisentangledNeRFModel(torch.nn.Module):
    def __init__(
        self,
        hidden_size=128,
        shape_code_size=128,
        ...
        self.layer_xyz1 = torch.nn.Linear(self.dim_xyz, self.hidden_size)
        self.layer_xyz2 = torch.nn.Linear(self.hidden_size, self.hidden_size)
        self.shape_code_layer1 = torch.nn.Linear(self.shape_code_size, self.shape_code_size)
        self.shape_code_layer2 = torch.nn.Linear(self.shape_code_size, self.shape_code_size)
        self.fc_out = torch.nn.Linear(self.hidden_size + self.shape_code_size, self.shape_code_size + 1)

        self.layer_rgb1 = torch.nn.Linear(self.dim_dir + self.shape_code_size, self.hidden_size)
        self.layer_rgb2 = torch.nn.Linear(self.hidden_size, self.hidden_size)
        self.texture_code_layer1 = torch.nn.Linear(self.shape_code_size + self.texture_code_size, self.texture_code_size)
